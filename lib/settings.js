...
module.exports = {
	...
	flowFile: path.join(process.env.NODE_RED_HOME, "data/flows.json"),
	 ...
	 * lost.
	 */
	credentialSecret: "ems-algorithm",
	 ...
	 */
	// userDir: "./data",
	userDir: path.join(process.env.NODE_RED_HOME, "data"),

	/** Node-RED scans the `nodes` directory in the userDir to find local node files.
	 * The following property can be used to specify an additional directory to scan.
	 */
	// nodesDir: "./data/nodes/",
	nodesDir: path.join(process.env.NODE_RED_HOME, "data/nodes"),
	...
	editorTheme: {
		...
		header: {
			...
			url: "http://localhost:18092", // optional url to make the header text/image a link to this url
		},
